...
/**
 * Created by duy21 on 9/22/2017.
 */

public class Exercise_Menu extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onCreate(Bundle saveInstanceState){
        ...
        ListMenu adapter=new ListMenu(Exercise_Menu.this,R.layout.item_menu,menuns);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_exercise) {
            ...
            Intent intent = new Intent(Exercise_Menu.this, WorkoutsActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_nutrition) {
            Intent intent = new Intent(Exercise_Menu.this, NutritionActivity.class);
            startActivity(intent);
