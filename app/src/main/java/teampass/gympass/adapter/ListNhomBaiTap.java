...
public class ListNhomBaiTap extends ArrayAdapter<NhomBaiTap> {
    Context mContext;
    ArrayList<NhomBaiTap> mNhom = new ArrayList<NhomBaiTap>();

    public ListNhomBaiTap(@NonNull Context context, @LayoutRes int resource, @NonNull List<NhomBaiTap> objects) {
        super(context, resource, objects);
        this.mContext = context;
        this.mNhom = new ArrayList<NhomBaiTap>(objects);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        NhomBaiTap obj = mNhom.get(position);
