...
public class ListNutrition extends ArrayAdapter<NhomBaiTap> {
    Context mContext;
    ArrayList<NhomBaiTap> mNhom = new ArrayList<NhomBaiTap>();

    public ListNutrition(@NonNull Context context, @LayoutRes int resource, @NonNull List<NhomBaiTap> objects) {
